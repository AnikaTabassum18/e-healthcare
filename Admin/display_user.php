...
<body><h1 class=" text-center font-weight-bold text-monospace text-info">USER NAME</h1>
...
<th class="text-center"><h2><input class="alert-danger" type ="submit" value="Delete" name="submit"></h2></th>
</tr></thead>
