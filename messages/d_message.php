...
<title>d_message</title>
</head>

<body>
<h1 align="center" class="text-capitalize text-center text-dark" style="font-size:36px">Message</h1><hr><br><br><br>
<?php 
...
<h2 style="color:#0000cc" style="font-size:16px">Reply Messages to Patient's</h2><hr>
<h3 class="text-capitalize font-weight-bold font-italic">  <?php
   session_start();
$d_email=$_SESSION['email'];
